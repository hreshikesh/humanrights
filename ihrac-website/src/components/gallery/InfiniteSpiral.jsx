...
const InfiniteSpiral = ({
  ...
  useEffect(() => {
    ...
    normalizedItems, speed, direction, animationMode, radius, perspective,
    cardWidth, cardHeight, verticalSpacing, cardsPerTurn, rotation, cardTilt,
    centerScale, edgeFade, edgeBlur, pauseOnHover
  ]);
        ...
        {normalizedItems.map((item, index) => {
          ...
          return (
            <Card
              ...
              className="absolute left-1/2 top-1/2 block h-[var(--spiral-height)] w-[var(--spiral-width)] overflow-hidden rounded-[var(--spiral-radius)] border border-[#D4AF37]/40 bg-white/10 shadow-[0_14px_38px_rgba(11,31,58,0.35)] [backface-visibility:hidden] [transform-style:preserve-3d] [will-change:transform,opacity,filter] motion-reduce:transition-none"
