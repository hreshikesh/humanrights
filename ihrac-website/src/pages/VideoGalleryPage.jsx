...
const VideoGalleryPage = () => {
  ...
  const bentoLayouts = useMemo(
    () => generateBentoLayout(parsedVideos.length),
    [parsedVideos]
  );
    ...
    <main className="relative bg-slate-50 py-24 sm:py-32 overflow-hidden select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative flex flex-col sm:flex-row items-center gap-5 p-6 sm:p-8 lg:p-10 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="mt-2 text-sm sm:text-base text-slate-300 max-w-xl">
                Real records of real actions from ground operations across India.
              </p>
            </div>
          </div>
        </motion.div>
